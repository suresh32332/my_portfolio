          ...
          return (
            <li key={index} className="group">
              <Link
                ...
                duration={500}
                offset={-130}
                className="cursor-pointer text-white hover:text-cyan transform-all duration-500"
              >
                {link.link}
              </Link>

              <div className="max-auto bg-cyan w-0 group-hover:w-full h-[1px] transform-all duration-500"></div>
            </li>
          );
        })}
      </ul>
